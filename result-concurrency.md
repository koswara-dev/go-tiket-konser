...
- **Kuota Tiket Awal:** 50
- **Jumlah Request Konkuren:** 100 request dari user berbeda secara serentak
- **Mekanisme Proteksi:** SQL Pessimistic Locking (`SELECT ... FOR UPDATE`)

## Hasil Pengujian
- **Total Request Terkirim:** 100
- **Transaksi Sukses (201 Created):** 50 (Sesuai dengan kuota awal)
- **Transaksi Gagal (400 Bad Request):** 50 (Karena kuota habis)
- **Status Response Lainnya:** 0
- **Sisa Kuota Tiket Akhir di DB:** 0
- **Rata-rata Latency Request:** 1580.08 ms

### Rincian Kegagalan (Error Messages)
- `kuota tiket 'Gold' tidak mencukupi (Tersisa: 0, Permintaan: 1)`: 50 kali
